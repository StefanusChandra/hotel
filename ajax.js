...
function validId(val) {
    if (val ==1){
        ...
        document.getElementById('id_card_no').setAttribute('placeholder',"737500100200");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter 12 Digit Valid KTP Card No");
    }else if(val ==2){
        ...
        document.getElementById('id_card_no').setAttribute('placeholder',"73710020030");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter 11 Character(include '/') Valid Voter KK Card No");
    }else if(val ==3){
        document.getElementById('id_card_no').setAttribute('type','text');
        document.getElementById('id_card_no').setAttribute('data-minlength','10');
        document.getElementById('id_card_no').setAttribute('placeholder',"4032170011");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter 10 Character Valid NPWP Card No");
    }else if(val == 4){
        document.getElementById('id_card_no').setAttribute('type','text');
        document.getElementById('id_card_no').setAttribute('data-minlength','16');
        document.getElementById('id_card_no').setAttribute('placeholder',"2112530091244670");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter 16 Character(include space) Valid SIM Number");
    }
}
